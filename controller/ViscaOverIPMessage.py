...
class ViscaOverIPMessage:
    ...
    PAYLOAD_TEMPLATES = {
            "VISCA_COMMAND": {
                ...
                "Preset1Save": bytearray([0x80, 0x01, 0x04, 0x3F, 0x01, 0x00, 0xFF]),
                "Preset2Save": bytearray([0x80, 0x01, 0x04, 0x3F, 0x01, 0x01, 0xFF]),
                "Preset3Save": bytearray([0x80, 0x01, 0x04, 0x3F, 0x01, 0x02, 0xFF]),
                "Preset4Save": bytearray([0x80, 0x01, 0x04, 0x3F, 0x01, 0x03, 0xFF]),
                "Preset5Save": bytearray([0x80, 0x01, 0x04, 0x3F, 0x01, 0x04, 0xFF]),
                "Preset6Save": bytearray([0x80, 0x01, 0x04, 0x3F, 0x01, 0x05, 0xFF]),
                "Preset7Save": bytearray([0x80, 0x01, 0x04, 0x3F, 0x01, 0x06, 0xFF]),
                "Preset8Save": bytearray([0x80, 0x01, 0x04, 0x3F, 0x01, 0x07, 0xFF]),
                "Preset9Save": bytearray([0x80, 0x01, 0x04, 0x3F, 0x01, 0x08, 0xFF]),
                "Preset10Save": bytearray([0x80, 0x01, 0x04, 0x3F, 0x01, 0x09, 0xFF]),
                "Preset11Save": bytearray([0x80, 0x01, 0x04, 0x3F, 0x01, 0x0A, 0xFF]),
                "Preset12Save": bytearray([0x80, 0x01, 0x04, 0x3F, 0x01, 0x0B, 0xFF]),
                "Preset13Save": bytearray([0x80, 0x01, 0x04, 0x3F, 0x01, 0x0C, 0xFF]),
                "Preset14Save": bytearray([0x80, 0x01, 0x04, 0x3F, 0x01, 0x0D, 0xFF]),
                "Preset15Save": bytearray([0x80, 0x01, 0x04, 0x3F, 0x01, 0x0E, 0xFF]),
                "Preset16Save": bytearray([0x80, 0x01, 0x04, 0x3F, 0x01, 0x0F, 0xFF]),
                "Preset1Recall": bytearray([0x80, 0x01, 0x04, 0x3F, 0x02, 0x00, 0xFF]),
                "Preset2Recall": bytearray([0x80, 0x01, 0x04, 0x3F, 0x02, 0x01, 0xFF]),
                "Preset3Recall": bytearray([0x80, 0x01, 0x04, 0x3F, 0x02, 0x02, 0xFF]),
                "Preset4Recall": bytearray([0x80, 0x01, 0x04, 0x3F, 0x02, 0x03, 0xFF]),
                "Preset5Recall": bytearray([0x80, 0x01, 0x04, 0x3F, 0x02, 0x04, 0xFF]),
                "Preset6Recall": bytearray([0x80, 0x01, 0x04, 0x3F, 0x02, 0x05, 0xFF]),
                "Preset7Recall": bytearray([0x80, 0x01, 0x04, 0x3F, 0x02, 0x06, 0xFF]),
                "Preset8Recall": bytearray([0x80, 0x01, 0x04, 0x3F, 0x02, 0x07, 0xFF]),
                "Preset9Recall": bytearray([0x80, 0x01, 0x04, 0x3F, 0x02, 0x08, 0xFF]),
                "Preset10Recall": bytearray([0x80, 0x01, 0x04, 0x3F, 0x02, 0x09, 0xFF]),
                "Preset11Recall": bytearray([0x80, 0x01, 0x04, 0x3F, 0x02, 0x0A, 0xFF]),
                "Preset12Recall": bytearray([0x80, 0x01, 0x04, 0x3F, 0x02, 0x0B, 0xFF]),
                "Preset13Recall": bytearray([0x80, 0x01, 0x04, 0x3F, 0x02, 0x0C, 0xFF]),
                "Preset14Recall": bytearray([0x80, 0x01, 0x04, 0x3F, 0x02, 0x0D, 0xFF]),
                "Preset15Recall": bytearray([0x80, 0x01, 0x04, 0x3F, 0x02, 0x0E, 0xFF]),
                "Preset16Recall": bytearray([0x80, 0x01, 0x04, 0x3F, 0x02, 0x0F, 0xFF]),
                "OSDEnable": bytearray([0x80, 0x01, 0x7E, 0x01, 0x18, 0x02, 0xFF]),
                "OSDDisable": bytearray([0x80, 0x01, 0x7E, 0x01, 0x18, 0x03, 0xFF])
            },
            "VISCA_INQUIRY": {
